...
<body bgcolor="#FFFFFF" text="#000000">  
    ...
    <form name="form1" method="post" action="alert.jsp">  <!--method:get/post;action:送出目的地-->
        <table width="60%" border="0" cellspacing="1" cellpadding="3"  
            ...
            <tr bgcolor="#FFFFFF">  
                <td width="20%"> </td>  
                <td width="80%"><textarea name="txtcontent" cols="45" rows="7"></textarea>  
                </td>  
            </tr>  
            <tr bgcolor="#FFFFFF">  
                <td width="20%"> </td>  
                ...
                <td colspan="2">  
                    <div align="center">  
                        ...
                        <input  
                            ...
                            onClick="MM_openBrWindow('messageboard.jsp'),'','toolbar=no, location=no,status=no,menubar=no,scrollbars=no,width=400,height=400'">  
                    </div>  
                </td>  
            </tr>  
        </table>  
